  ...
  return (
    <ColumnPage>
      ...
      <ColumnCallout label="한 줄 요약">
        ...
        <strong>이 신호가 곧 매수·매도 기준입니다.</strong><br /><br />
      ...
      <ColumnMythFact
        ...
        fact="하루 이틀의 돌파는 잡음일 수 있습니다. 앗추 필터는 20거래일 중 16일 이상 200일선 위에 있을 때만 추세가 유효하다고 판단합니다. 성급한 진입을 막고, 안정적인 상승 추세에서만 매수 신호를 보냅니다."
      />
