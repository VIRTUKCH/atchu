...
const COLORS = { faberSector: "#22c55e", spy: "#f59e0b", sixtyForty: "#a855f7" };
const LABELS = { faberSector: "Faber 섹터", spy: "SPY B&H", sixtyForty: "60/40" };
...
export default function FaberEquityCurveChart({ equityCurve }) {
