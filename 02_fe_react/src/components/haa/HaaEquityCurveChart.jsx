...
const COLORS = { haa: "#22c55e", spy: "#f59e0b", sixtyForty: "#a855f7" };
const LABELS = { haa: "HAA", spy: "SPY B&H", sixtyForty: "60/40" };
...
export default function HaaEquityCurveChart({ equityCurve }) {
