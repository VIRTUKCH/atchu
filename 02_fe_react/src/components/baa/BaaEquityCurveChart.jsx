...
const COLORS = { aggressive: "#22c55e", balanced: "#3b82f6", spy: "#f59e0b", sixtyForty: "#a855f7" };
const LABELS = { aggressive: "BAA-A", balanced: "BAA-B", spy: "SPY B&H", sixtyForty: "60/40" };
...
export default function BaaEquityCurveChart({ equityCurve }) {
